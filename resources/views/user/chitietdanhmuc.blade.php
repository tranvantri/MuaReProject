  ...
  <div class="container">
    ...
    <?php $checknull= false;
     ...
     <div class="md-modal md-effect-1" id="modal-productview">
      ...
      <!-- The Modal -->
      <div class="modal fade md-modal2" id="modal-orderview">
            ...
            <div class="modal-body">
              <!--<div class="md-modal2 md-effect-1" id="modal-orderview">-->
               ...
               <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                     <a class="nav-link active" data-toggle="tab" href="#step1">Thông tin sản phẩm</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" data-toggle="tab" href="#step2">Nơi nhận hàng</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" data-toggle="tab" href="#step3">Xác nhận đơn hàng</a>
                  </li>
               </ul>
               <!-- Tab panes -->
                  ...
                  <div id="step1" class="container tab-pane active" style="padding-right: 0; padding-left: 0;">
                    ...
                    <div class="product-in-order-L">
                      ...
                      <div style="margin: 38px 10px 10px 10px;">
                        ...
                        <button class="btn order-btn2">TIẾP TỤC</button>
                      </div>
                  </div>
                  ...
                  <div id="step2" class="container tab-pane fade">
                     ...
                     <!--<div>
                      ...
                      <div style="margin: 10px;">
                        <button class="btn order-btn1">QUAY LẠI</button>
                        <button class="btn order-btn2">TIẾP TỤC</button>
                      </div>
                  </div>
