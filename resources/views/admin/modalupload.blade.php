	      	...
	      	<div class="modal-body">   
	      		<div class="container-fluid">
					...
					<div align="center" style="margin-top: 2px;">
						<div id="cartegory-upload" cartegory="logo"></div>
					...
					<div style="border: 1px solid #ddd;padding: 5px; margin-top: 2px;">
						<ul class="nav nav-tabs">
							<li class="active"><a id="logo2" data="logo" data-toggle="tab" href="#logo">Logo</a></li>
						...
						<div class="tab-content">
						    <div id="logo" class="tab-pane fade in active stroll-div">
						    	<div class="row">
						    		<div class="col-lg-2">
						    			<div class="card">
