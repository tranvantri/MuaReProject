                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="admin/dichvu/enable/{{$child->id}}/{{1}}">Đã duyệt</a></li>
                                    <li><a href="admin/dichvu/enable/{{$child->id}}/{{0}}">Chưa duyệt</a></li>
                                    <li><a href="admin/dichvu/enable/{{$child->id}}/{{2}}">Khóa</a></li>
                                </ul>
                            </div>
                        </td>                                         
                        <td><button class="view-info-dichvu btn btn-info" data="{{$child->id}}" data-toggle="modal" data-target="#myModalProInfo">Xem</button></td>
